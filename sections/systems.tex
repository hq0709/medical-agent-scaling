...
This design gives the panel a single point at which errors can be caught before they reach
the output. It is the architecture we find responsible for both the largest gain and the
largest loss in the study.
