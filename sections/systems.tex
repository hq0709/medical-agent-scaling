...
\caption{\textbf{The five canonical architectures}, following the formalisation of
\citet{kim2026scaling}, with the clinical instantiation used here. $A$ is the agent set, $C$ the
communication graph, $\Omega$ the aggregation rule.}
\label{fig:arch}
\end{figure}
...
$\Omega$. Figure~\ref{fig:arch} and Table~\ref{tab:arch} give the five canonical configurations together with the clinical
