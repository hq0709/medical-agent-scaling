...
\caption{Complete results grid (1 of 4). All 180 multi-agent configurations and their single-model controls.}
\label{tab:full}
...
\begin{table*}[t]\centering\scriptsize
\caption{Complete results grid (2 of 4). All 180 multi-agent configurations and their single-model controls.}
\begin{tabular}{@{}llllrrr@{}}
\toprule
Tier & Benchmark & Architecture & $n_a$ & Acc.\ (\%) & 95\% CI & USD/1k \\
\midrule
...
\begin{table*}[t]\centering\scriptsize
\caption{Complete results grid (3 of 4). All 180 multi-agent configurations and their single-model controls.}
\begin{tabular}{@{}llllrrr@{}}
\toprule
Tier & Benchmark & Architecture & $n_a$ & Acc.\ (\%) & 95\% CI & USD/1k \\
\midrule
...
\begin{table*}[t]\centering\scriptsize
\caption{Complete results grid (4 of 4). All 180 multi-agent configurations and their single-model controls.}
\begin{tabular}{@{}llllrrr@{}}
\toprule
Tier & Benchmark & Architecture & $n_a$ & Acc.\ (\%) & 95\% CI & USD/1k \\
\midrule
